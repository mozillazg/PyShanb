...
def default_config(configs, configfile):
    # configs.add_section('Others')
    # configs.set('Others', 'site', 'http://www.shanbay.com')
    # configs.set('Others', 'url_login', '/accounts/login/')
    # configs.set('Others', 'api_get_word', '/api/word/%s')
    # configs.set('Others', 'api_add_word', '/api/learning/add/%s')
    # configs.set('Others', 'api_get_example', '/api/learning/examples/%s')
    ...
    # configs.set('General', 'enable_iciba', '0')
    # configs.set('General', 'iciba_audio', '0')
...
if not (os.path.isfile(CONFIGFILE) and config.has_section('General')
